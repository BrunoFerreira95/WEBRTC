    ...
    <div className="bg-fundo min-h-screen max-h-fit p-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 mb-4">
            ...
            <div className="videos flex flex-col items-center w-full md:w-2/3">
                <div className="relative w-full max-w-2xl aspect-video mb-4">
                 ...
                 <div className="flex  justify-center">
                        {showStop ? (
                        <button ref={stopButtonRef} onClick={stopOffer} className="bg-red-500 text-white font-bold px-4 py-2 rounded-md hover:bg-red-700 transition-all duration-300">
        ...
        <div className="flex flex-col w-full md:w-1/3 max-w-sm">
          <div className="bg-gray-100 p-4 rounded-md shadow-md flex flex-col gap-2 mb-4">
            ...
            <button onClick={sendSignal} className="bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 p-3 rounded-md transition duration-300 flex justify-center">
